...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package catppuccin-theme
    ...
    ;; Customization
    (catppuccin-set-color 'rosewater "#3D4059")
    (catppuccin-set-color 'flamingo "#9CA6B9")
    (catppuccin-set-color 'pink "#c3889e")
    (catppuccin-set-color 'mauve "#a078a9")
    (catppuccin-set-color 'red "#C35864")
    (catppuccin-set-color 'maroon "#B7535E")
    (catppuccin-set-color 'peach "#D88B72")
    (catppuccin-set-color 'yellow "#DE956F")
    (catppuccin-set-color 'green "#8D8675")
    (catppuccin-set-color 'teal "#798d99")
    (catppuccin-set-color 'sky "#797eac")
    (catppuccin-set-color 'sapphire "#797eac")
    (catppuccin-set-color 'blue "#797eac")
    (catppuccin-set-color 'lavender "#8f87ac")
    ...
    (catppuccin-set-color 'surface0 "#040404")
