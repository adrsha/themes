...
(defvar bgcolor "#131C19"
  "The normal background of emacs.")
(defvar darker-bgcolor "#111916"
  "The darker background of emacs.")
(defvar darkest-bgcolor "#101715"
  "The darker background of emacs.")
(defvar dim-fgcolor "#343c39"
  "The calm foreground of emacs.")
(defvar calm-fgcolor "#40534e"
  "The calm foreground of emacs.")
(defvar lavender-color "#444f58"
  "The blue color for emacs.")
(defvar blue-color "#324448"
  "The blue color for emacs.")
(defvar pink-color "#4d4059"
  "The pink color for emacs.")
(defvar red-color "#333129"
  "The red color for emacs.")
(defvar teal-color "#324a43"
  "The pink color for emacs.")
(defvar grim-fgcolor "#252c2a"
  "The calm foreground of emacs.")
...
Intended for `after-make-frame-functions'."
  ...
  (set-face-attribute 'region nil :background darker-bgcolor)
  ;; kind icons
  ...
  (set-face-attribute 'flycheck-error nil :background "#2a2923" :foreground "#333129" :underline 'nil :weight 'bold)
  (set-face-attribute 'flycheck-info nil :background "#273120" :foreground "#364629" :underline 'nil :weight 'bold)
  (set-face-attribute 'flycheck-warning nil :background "#2e2e1f" :foreground "#434329" :underline 'nil :weight 'bold)
  ...
  (with-current-buffer " *Echo Area 0*" (face-remap-add-relative 'default '(:family "Iosevka Nerd Font ExtraBold")))
  (set-face-attribute 'dashboard-banner-logo-title-face nil :inherit 'eaBattery-icon)
