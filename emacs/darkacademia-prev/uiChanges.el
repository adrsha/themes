...
(defvar bgcolor "#000000"
  "The normal background of emacs.")
(defvar darker-bgcolor "#0a0a0a"
  "The darker background of emacs.")
(defvar darkest-bgcolor "#010101"
  "The darker background of emacs.")
(defvar dim-fgcolor "#605553"
  "The calm foreground of emacs.")
(defvar calm-fgcolor "#a58a88"
  "The calm foreground of emacs.")
(defvar lavender-color "#8f87ac"
  "The blue color for emacs.")
(defvar blue-color "#797eac"
  "The blue color for emacs.")
(defvar pink-color "#c3889e"
  "The pink color for emacs.")
(defvar red-color "#C35864"
  "The red color for emacs.")
(defvar teal-color "#798d99"
  "The pink color for emacs.")
(defvar grim-fgcolor "#271C1A"
  "The calm foreground of emacs.")
...
Intended for `after-make-frame-functions'."
  ...
  (set-face-attribute 'variable-pitch nil :font "Barlow" :weight 'regular)


  ;; vertico
  (set-face-attribute 'vertico-multiline nil :background darker-bgcolor)
  (set-face-attribute 'vertico-posframe nil :weight 'bold :inherit 'vertico-multiline :background darker-bgcolor)
  (set-face-attribute 'vertico-posframe-border nil :inherit 'ansi-color-white :background darker-bgcolor)
  (set-face-attribute 'vertico-posframe-border-2 nil :inherit 'ansi-color-white :background darker-bgcolor)
  (set-face-attribute 'vertico-posframe-border-3 nil :inherit 'ansi-color-white :background darker-bgcolor)
  (set-face-attribute 'vertico-posframe-border-4 nil :inherit 'ansi-color-white :background darker-bgcolor)
  ...
  (set-face-attribute 'region nil :background grim-fgcolor)
  ...
  (set-face-attribute 'link nil :background darker-bgcolor :foreground calm-fgcolor :slant 'oblique  :weight 'regular :overline 'nil :underline 'nil :family "ETbb")
  ...
  (with-eval-after-load 'org-faces
    ...
    (set-face-attribute 'org-level-1 nil :height 250 :family "ETbb" :weight 'bold :foreground calm-fgcolor)
    (set-face-attribute 'org-level-2 nil :height 240 :family "ETbb" :weight 'bold :foreground calm-fgcolor)
    (set-face-attribute 'org-level-3 nil :height 235 :family "ETbb" :weight 'bold :foreground calm-fgcolor)
    (set-face-attribute 'org-level-4 nil :height 230 :family "ETbb" :weight 'bold :foreground calm-fgcolor)
    (set-face-attribute 'org-level-5 nil :height 225 :family "ETbb" :weight 'bold :foreground calm-fgcolor)
    (set-face-attribute 'org-level-6 nil :height 220 :family "ETbb" :weight 'bold :foreground calm-fgcolor)
    (set-face-attribute 'org-level-7 nil :height 215 :family "ETbb" :weight 'bold :foreground calm-fgcolor)
    (set-face-attribute 'org-level-8 nil :height 210 :family "ETbb" :weight 'bold :foreground calm-fgcolor)
	...
	(set-face-attribute 'org-agenda-structure nil :font "Abel" :weight 'regular :height 230 :foreground calm-fgcolor)
  ...
  (set-face-attribute 'org-document-title nil :height 260 :font "ETbb" :weight 'bold :foreground red-color)
  ...
  (set-face-attribute 'dashboard-banner-logo-title-face nil :family "ETbb" :foreground "#CBA6F7")
