...
(use-package evil
  ...
  (setq evil-emacs-state-cursor    '("#4d4055" box))
  (setq evil-normal-state-cursor   '("#40534e" box))
  (setq evil-operator-state-cursor '("#324448" (bar . 6)))
  (setq evil-visual-state-cursor   '("#324448" box))
  (setq evil-insert-state-cursor   '("#444f58" (bar . 2)))
  (setq evil-replace-state-cursor  '("#4b4329" hbar))
  (setq evil-motion-state-cursor   '("#333129" box))
  :config
  (evil-mode 1)
  ;; INITIAL BINDINGS
...
(use-package catppuccin-theme
  ...
  (catppuccin-set-color 'pink "#4d4055")
  (catppuccin-set-color 'mauve "#4d4046")
  ...
  (catppuccin-set-color 'lavender "#444f58")
